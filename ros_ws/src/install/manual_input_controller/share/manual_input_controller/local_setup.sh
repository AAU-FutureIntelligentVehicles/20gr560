...
: ${AMENT_CURRENT_PREFIX:="/home/frederik/git/20gr560/ros_ws/src/install/manual_input_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/manual_input_controller/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/manual_input_controller/environment/path.sh"
