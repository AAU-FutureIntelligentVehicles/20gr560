...
int main(int argc, char** argv){
    ros::init(argc, argv, "transform_publisheris");
    ros::NodeHandle n;
	...
	/*tf::Transform transform2;
        ...
        transform3.setOrigin( tf::Vector3(1.18, 0, 0.27) );
        tf::Quaternion q3;
        q3.setRPY(0, 0, 0);
        ...
        transform4.setOrigin( tf::Vector3(1.07, 0, 1.38) );
        tf::Quaternion q4;
        ...
        transform5.setOrigin( tf::Vector3(-1.02, 0, 0.27) );  //(-1.02, 0, c0.27)
        tf::Quaternion q5;
