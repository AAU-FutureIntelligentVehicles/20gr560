...
int main(int argc, char **argv)
{
  ...
  ros::NodeHandle nh;
  ros::NodeHandle n("~");
  ros::Publisher scan_pub = nh.advertise<sensor_msgs::LaserScan>("scan_front", 1);

  n.param<std::string>("host", host, "169.254.196.14");
  n.param<std::string>("frame_id", frame_id, "laser_front");
